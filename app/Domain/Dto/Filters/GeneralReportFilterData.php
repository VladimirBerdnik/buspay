...
/**
 * Details to retrieve general report data.
 *
 ...
 * @property-read integer|null $driver_id Identifier of driver that owns route sheet
 */
class GeneralReportFilterData extends Dto
{
    ...
    /**
     * Identifier of driver that owns route sheet.
     *
     * @var integer|null
     */
    protected $driver_id;
